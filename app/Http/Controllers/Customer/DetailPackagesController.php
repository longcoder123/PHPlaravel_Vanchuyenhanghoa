...
class DetailPackagesController extends Controller
{
    ...
    ->select('orders.order_id', 'orders.status as order_status', 'packages.status as package_status','orders.receiver_name','orders.sender_address','orders.receiver_address','orders.delivery_date','orders.shipping_fee','orders.order_date as order_date')
    ->get();
